...
namespace API.Inspecciones.Persistence
{
    public class Context : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<InspeccionFichero>().HasOne(item => item.Inspeccion).WithMany(item => item.InspeccionesFicheros).HasForeignKey(item => item.IdInspeccionFichero).OnDelete(DeleteBehavior.Restrict);
